...
const Legend = ({ labels, colors }) => (
    <Box sx={{display:'flex', float:'right', width:'100%', whiteSpace:'nowrap' ,mt: 0.6, mb:0.3}}>
        {labels.map((label, index) => (
            ...
            <Box sx={{ width: 12, height: 12, backgroundColor: colors[index], mr: 1 , border: '1px solid #fff'  }} />
        ...
        {displayItems.map((error, index) => (
          ...
          >
            <Box className='SlideProgress' sx={{ width: '40%', textAlign: 'left', pl: 0.5, }}>
              <Typography sx={{ whiteSpace: 'nowrap',bottom:0, color: '#ffffff00 !important', marginBottom: '0' }} variant="body2" color="textSecondary" gutterBottom>
                .
              </Typography>
              <ProgressContainer>
                <StyledLinearProgress
                  ...
                  sx={{ 
                    ...
                    '& .MuiLinearProgress-bar': { backgroundColor: Colors[0] },
                }}
                />
                <ProgressText
                  sx={{
            ...
            <Box className='SlideProgress' sx={{ width: '60%', textAlign: 'left', pl: 0.5 }}>
              <Typography className='headerSlideProgress' sx={{ whiteSpace: 'nowrap', color: theme.palette.primary.conponent, marginBottom: '0' }} variant="body2" color="textSecondary" gutterBottom>
                {error.Series}
              </Typography>
              <ProgressContainer>
                <StyledLinearProgress
                  ...
                  sx={{'& .MuiLinearProgress-bar': { backgroundColor: Colors[1] },}}
                />
                <ProgressText
                  sx={{
