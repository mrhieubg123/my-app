...
const ColumnChart = ({ idata = [], onModelChange }) => {
  ...
  const options = {
    ...
    xAxis: {
      categories:
        idata.length > 0
          ? idata.map((item) => item.DateT.split("T")[0])
    ...
    plotOptions: {
      column: {
        ...
        dataLabels: {
          enabled: true,
          style: { fontSize: "0.6rem", color: theme.palette.chart.color },
        },
        borderWidth: 0,
      },
    ...
    series: [
      ...
      //   data:
      //     idata.length > 0
      //       ? idata.map((item) => item.ActualMain)
      //       : [1, 2, 3, 4, 5, 6],
      //   stack: "budget",
      //   color: "#26c1a2",
      // },
