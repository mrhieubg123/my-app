...
const HiProgressBar = ({
  ...
  const displayItems = useMemo(() => {
    return [
      { Downtime: 100, Series: "Stencil 1" },
      { Downtime: 70, Series: "Stencil 2" },
      { Downtime: 65, Series: "Stencil 3" },
      { Downtime: 50, Series: "Stencil 4" },
      { Downtime: 20, Series: "Stencil 5" },
    ];
    return DataSeries;
    ...
    <>
      ...
      <Box sx={{ position: "relative" }}>
        ...
        {displayItems.map((error, index) => (
          <Box
            onClick={() => handleChangeErrorDetail(error.Series)}
