    ...
    plotOptions: {
      pie: {
        ...
        dataLabels: {
          enabled: true,
          format:
            "<b>{point.name}</b>:<br/><b>{point.y}</b> ({point.percentage:.1f} %) ",
            ...
            <TableHead sx={{ position: "sticky", top: "0" }}>
              <TableRow>
                <TableCell
                  ...
                  align="center"
                >
                  ErrorCode: {idata?.map((item) => item["ERROR_CODE"])[0]}
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell
                ...
                <TableRow key={index}>
                  ...
                  <TableCell
                    ...
                    sx={{
                      ...
                      cursor: "pointer",
                      fontSize: "1.2rem",
                      backgroundColor: brightenColor("#00adff", index * 10),
                    }}
                  >
                    {row.Total || "0"}
                  </TableCell>
